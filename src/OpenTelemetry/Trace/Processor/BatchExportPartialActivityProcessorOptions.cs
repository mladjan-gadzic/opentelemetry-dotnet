...
/// </summary>
public class BatchExportPartialActivityProcessorOptions : BatchExportProcessorOptions<Activity>
{
    // TODO rename OTEL_BSP_MAX_QUEUE_SIZE to OTEL_BPSP_MAX_QUEUE_SIZE
    // TODO find its usage
    ...
    /// </summary>
    public BatchExportPartialActivityProcessorOptions()
        : this(new ConfigurationBuilder().AddEnvironmentVariables().Build())
    {
    }

    internal BatchExportPartialActivityProcessorOptions(IConfiguration configuration)
    {
